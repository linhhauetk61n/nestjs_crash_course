...
let UserService = class UserService {
    ...
    async register(createUserDto) {
        ...
        if (existingUser)
            throw new common_1.BadRequestException(`Email: ${createUserDto.email} is already exist!`);
...
__decorate([
    (0, event_emitter_1.OnEvent)(event_constant_1.event.RESPONSE_SUBMITTED),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], UserService.prototype, "handleIfResponseIsCorrect1", null);
